  ...
  private circuits: CircuitEntry[] = [
    {
      ...
      description:
        "Full Subtractor circuit using Verilog. This circuit can subtract two bits and borrow in a single operation.",
      authorId: "user1",
      authorName: "John Doe",
      dateCreated: new Date("2023-01-15"),
      dateModified: new Date("2023-02-20"),
      tags: ["adder", "subtractor", "arithmetic"],
...
or o1(bout, w2, w3);
  ...
  async addComment(
    circuitId: string,
    comment: Omit<Comment, "id" | "date" | "likes">,
  ): Promise<Comment> {
